          ...
          <div class="count-contain-left-form" >
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
              ...
              <el-form-item style="margin-top: 10%;width: 60%;position: relative" prop="checkNum">
                ...
                <el-button id="button" @click="getNum('ruleForm')" type="danger" style="position: absolute;top:1px;left:175px">发送验证码</el-button>
          ...
          var myreg = /^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-3]{1})|(15[4-9]{1})|(18[0-9]{1})|(199))+\d{8})$/;
            if (!myreg.test(this.ruleForm.phoneNum)) {
              ...
              this.ruleForm.phoneNum = '';
                ...
                axios({
                  url:'http://xm626.free.idcfengye.com/sendMessage?phone='+this.phoneNum,//url.控制器下的方法
                  method:'post',
                  data:{
