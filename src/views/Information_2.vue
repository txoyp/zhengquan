    ...
    export default {
      ...
      data() {
        return {
          ...
          rules: {
            ...
            account_type:[{required: true, message: '请选择开户银行！', trigger: 'change'}],
            account_num:[
              {required: true, message: '卡号不能为空！', trigger: 'blur'},
              {min: 19, max: 19, message: '请输入正确的手机号', trigger: 'blur'},

            ],
            account_pass:[{required: true, message: '交易密码不能为空！', trigger: 'blur'}]
          },
            options: [{
              account_type: '中国银行',
              label: '中国银行'
      ...
      methods:{
        submitForm(formName) {
          ...
          // console.log(this.ruleForm.account_type);
          // console.log(this.ruleForm.account_num);
          // console.log(this.ruleForm.account_pass);
          ...
          this.$refs[formName].validate((valid) => {
            if (valid) {
              ...
              axios({
                url:'http://xm626.free.idcfengye.com/openUser?phone_number='+this.ruleForm.phone_number +'&userName='+this.ruleForm.name+'&accountType='+this.ruleForm.account_type +'&accountNum='+this.ruleForm.account_num+'&account_password='+this.ruleForm.account_pass+'&userSex='+this.ruleForm.sex,
                method:'post',
                data:{
